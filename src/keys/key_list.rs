...
pub struct KeysList {
	...
	pub tab_gitignore: RustedGitKeyEvent,
	...
	pub gitignore_save: RustedGitKeyEvent,
...
impl Default for KeysList {
	fn default() -> Self {
		Self {
			...
			tab_gitignore: RustedGitKeyEvent::new(KeyCode::Char('8'),  KeyModifiers::empty()),
			...
			gitignore_save: RustedGitKeyEvent::new(KeyCode::Char('s'),  KeyModifiers::CONTROL),
