...
pub struct KeysList {
	...
	pub tab_graph: GituiKeyEvent,
	pub tab_create_pr: GituiKeyEvent,
...
impl Default for KeysList {
	fn default() -> Self {
		Self {
			...
			tab_graph: GituiKeyEvent::new(KeyCode::Char('6'),  KeyModifiers::empty()),
			tab_create_pr: GituiKeyEvent::new(KeyCode::Char('7'),  KeyModifiers::empty()),
